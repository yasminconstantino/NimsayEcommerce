...
/* pedido */
  ...
  function abrirCarrinho() {
    ...
    carrinho.classList.remove("visibility-[hidden]");
 ...
 function inicializarCarrinho() {
  ...
  function atualizarPrecoCarrinho() {
    ...
    for (const idProdutoNoCarrinho in idsProdutoCarrinhoComQuantidade) {
      precoTotalCarrinho += catalogooo.find((p) => p.id === idProdutoNoCarrinho).preco * idsProdutoCarrinhoComQuantidade[idProdutoNoCarrinho];
    }
